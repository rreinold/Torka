        ...
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {/* Comprehension Speed */}
              <Card className="md:col-span-3" data-testid="card-comprehension-speed">
                <CardHeader>
                  <CardTitle>Comprehension Speed by Media Type</CardTitle>
                  <CardDescription>How quickly you grasp concepts with different formats</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={250}>
                    <LineChart data={comprehensionSpeedData}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="diagrams" stroke="#10b981" strokeWidth={2} />
                      <Line type="monotone" dataKey="interactive" stroke="#3b82f6" strokeWidth={2} />
                      <Line type="monotone" dataKey="videos" stroke="#f59e0b" strokeWidth={2} />
                      <Line type="monotone" dataKey="text" stroke="#8b5cf6" strokeWidth={2} />
                      <Line type="monotone" dataKey="audio" stroke="#ec4899" strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
